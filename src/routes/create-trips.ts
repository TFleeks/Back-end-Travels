...
export async function createTrip(app: FastifyInstance) {
    app.withTypeProvider<ZodTypeProvider>().post('/trips', {
        ...
        const confirmation_link = `${env.API_BASE_URL}/trips/${trip.id}/confirm`
        ...
        const message = await mail.sendMail({
            ...
            <div style="font-family: sans-serif; font-size: 16px; line-height: 1.6;">
                <p>Você solicitou a criação de uma viagem para <strong>${ destination }</strong>, Brasil <strong>nas datas de ${ formattedStartDate }</strong> até <strong> ${ formattedEndDate } </strong>.</p>
                <p></p>
